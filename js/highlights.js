...
const HL_DSO = [
  { key:"pleiades", ra:3.790, dec:24.11, mag:1.6, inst:"eye", emoji:"✨", fame:88,
    name:{en:"The Pleiades (Seven Sisters)", fr:"les Pléiades"},
    blurb:{en:"A sparkling little cluster of blue baby stars — how many can you count?", fr:"un petit amas scintillant de jeunes étoiles bleues — combien peux-tu en compter ?"} },
  { key:"orion", ra:5.588, dec:-5.39, mag:4.0, inst:"eye", emoji:"🌫️", fame:92,
    name:{en:"The Orion Nebula", fr:"la nébuleuse d'Orion"},
    blurb:{en:"A glowing cloud where brand-new stars are being born, in Orion's sword.", fr:"un nuage lumineux où naissent de nouvelles étoiles, dans l'épée d'Orion."} },
  { key:"andromeda", ra:0.712, dec:41.27, mag:3.4, inst:"eye", emoji:"🌌", fame:90,
    name:{en:"The Andromeda Galaxy", fr:"la galaxie d'Andromède"},
    blurb:{en:"The most distant thing your eyes can see — a whole galaxy, 2.5 million light-years away.", fr:"l'objet le plus lointain visible à l'œil nu — une galaxie entière, à 2,5 millions d'années-lumière."} },
  { key:"beehive", ra:8.674, dec:19.98, mag:3.7, inst:"binoc", emoji:"🐝", fame:72,
    name:{en:"The Beehive Cluster", fr:"l'amas de la Ruche"},
    blurb:{en:"A fuzzy patch to the eye that bursts into a swarm of stars in binoculars.", fr:"une tache floue à l'œil nu qui devient un essaim d'étoiles aux jumelles."} },
  { key:"m13", ra:16.695, dec:36.46, mag:5.8, inst:"binoc", emoji:"🔵", fame:78,
    name:{en:"The Great Hercules Cluster", fr:"l'amas d'Hercule"},
    blurb:{en:"A tight ball of hundreds of thousands of ancient stars.", fr:"une boule serrée de centaines de milliers d'étoiles anciennes."} },
  { key:"double", ra:2.33, dec:57.14, mag:3.8, inst:"binoc", emoji:"✨", fame:74,
    name:{en:"The Double Cluster", fr:"le Double Amas"},
    blurb:{en:"Two glittering star clusters side by side — beautiful in binoculars.", fr:"deux amas d'étoiles scintillants côte à côte — superbes aux jumelles."} },
  { key:"lagoon", ra:18.06, dec:-24.38, mag:4.6, inst:"binoc", emoji:"🌫️", fame:70,
    name:{en:"The Lagoon Nebula", fr:"la nébuleuse de la Lagune"},
    blurb:{en:"A bright star-forming cloud toward the centre of our galaxy.", fr:"un nuage lumineux de formation d'étoiles vers le centre de la galaxie."} },
  { key:"omegacen", ra:13.446, dec:-47.48, mag:3.9, inst:"eye", emoji:"🔵", fame:86,
    name:{en:"Omega Centauri", fr:"Oméga du Centaure"},
    blurb:{en:"The biggest, brightest globular cluster — millions of stars in one ball.", fr:"le plus grand et le plus brillant amas globulaire — des millions d'étoiles."} },
  { key:"m22", ra:18.606, dec:-23.90, mag:5.1, inst:"binoc", emoji:"🔵", fame:68,
    name:{en:"The Sagittarius Cluster (M22)", fr:"l'amas M22 du Sagittaire"},
    blurb:{en:"A big, bright ball of stars near the heart of the Milky Way.", fr:"une grande boule d'étoiles brillante près du cœur de la Voie lactée."} },
  { key:"m7", ra:17.897, dec:-34.79, mag:3.3, inst:"eye", emoji:"✨", fame:66,
    name:{en:"The Ptolemy Cluster (M7)", fr:"l'amas de Ptolémée (M7)"},
    blurb:{en:"A bright scatter of stars known since ancient times.", fr:"une dispersion d'étoiles brillantes connue depuis l'Antiquité."} },
  { key:"albireo", ra:19.512, dec:27.96, mag:3.1, inst:"scope", emoji:"🎨", fame:62,
    name:{en:"Albireo (a colourful double star)", fr:"Albiréo (étoile double colorée)"},
    blurb:{en:"One star that splits into a gold and a blue jewel in a small telescope.", fr:"une étoile qui se sépare en un joyau doré et un bleu dans une petite lunette."} },
  { key:"ring", ra:18.885, dec:33.03, mag:8.8, inst:"scope", emoji:"💍", fame:64,
    name:{en:"The Ring Nebula", fr:"la nébuleuse de l'Anneau"},
    blurb:{en:"A perfect smoke-ring puffed out by a dying star (needs a telescope).", fr:"un anneau de fumée parfait soufflé par une étoile mourante (télescope)."} },
  { key:"whirlpool", ra:13.497, dec:47.20, mag:8.4, inst:"scope", emoji:"🌀", fame:66,
    name:{en:"The Whirlpool Galaxy", fr:"la galaxie du Tourbillon"},
    blurb:{en:"Two galaxies caught mid-dance — a classic spiral (telescope).", fr:"deux galaxies en pleine danse — une spirale classique (télescope)."} },
];

// Planets & Moon — base interest, emoji, instrument, and blurb.
const HL_SS = {
  Moon:    { base:82, emoji:"🌙", inst:"binoc", blurb:{en:"Our nearest neighbour — binoculars reveal craters, mountains and dark 'seas'.", fr:"notre plus proche voisine — les jumelles révèlent cratères, montagnes et « mers » sombres."} },
  Venus:   { base:96, emoji:"♀", inst:"eye", blurb:{en:"The dazzling 'evening/morning star' — the brightest planet, impossible to miss.", fr:"l'éblouissante « étoile du soir/matin » — la planète la plus brillante, impossible à manquer."} },
  Jupiter: { base:95, emoji:"♃", inst:"binoc", blurb:{en:"The biggest planet — with binoculars you can spot its four largest moons as tiny dots.", fr:"la plus grande planète — aux jumelles, repère ses quatre plus grandes lunes en petits points."} },
  Saturn:  { base:90, emoji:"♄", inst:"scope", blurb:{en:"Its rings are the jewel of the night sky — any small telescope shows them.", fr:"ses anneaux sont le joyau du ciel — la moindre petite lunette les montre."} },
  Mars:    { base:84, emoji:"♂", inst:"eye", blurb:{en:"The Red Planet, glowing amber to the naked eye.", fr:"la planète rouge, d'un éclat ambré à l'œil nu."} },
  Mercury: { base:58, emoji:"☿", inst:"eye", blurb:{en:"Elusive and quick — catch it low in the sky just after sunset or before sunrise.", fr:"insaisissable et rapide — attrape-la basse, juste après le coucher ou avant le lever du Soleil."} },
  Uranus:  { base:46, emoji:"⛢", inst:"binoc", blurb:{en:"A faint blue-green world — a fun challenge to hunt down with binoculars.", fr:"un monde bleu-vert pâle — un joli défi à débusquer aux jumelles."} },
  Neptune: { base:34, emoji:"♆", inst:"scope", blurb:{en:"The most distant planet — you'll need a telescope to catch its tiny blue dot.", fr:"la planète la plus lointaine — il faut un télescope pour saisir son petit point bleu."} },
};
